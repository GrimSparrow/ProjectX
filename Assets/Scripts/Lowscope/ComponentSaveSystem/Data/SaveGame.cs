...
namespace Lowscope.Saving.Data
{
    ...
    public class SaveGame
    {
        ...
        public void Set(string instanceGuid, string prefabPath, string id, string data, string scene)
        {
            int saveIndex;

            if (saveDataCache.TryGetValue(id, out saveIndex))
            {
                saveData[saveIndex] = new Data() {instanceGuid = instanceGuid, prefabPath = prefabPath, guid = id, data = data, scene = scene };
            }
            else
            {
                Data newSaveData = new Data() { instanceGuid = instanceGuid, prefabPath = prefabPath, guid = id, data = data, scene = scene };
