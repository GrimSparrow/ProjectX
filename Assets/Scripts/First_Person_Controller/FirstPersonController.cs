        ...
        #region Custom Methods
            ...
            #region Locomotion Calculation Methods
                ...
                protected virtual bool CheckIfRoof() /// TO FIX
                {
                    ...
                    bool _hitRoof = Physics.SphereCast(_origin,raySphereRadius,Vector3.up,out _roofInfo,m_initHeight, obstacleLayers);
            ...
            #region Crouching Methods
                ...
                protected virtual IEnumerator CrouchRoutine()
                {
                    ...
                    float _camDesiredHeight = movementInputData.IsCrouching ? 0f : m_crouchCamHeight;
